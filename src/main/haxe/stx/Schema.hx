...
typedef FieldPropertyDeclaration    = stx.schema.FieldPropertyDeclaration;
typedef FieldPropertyDeclarationDef = stx.schema.FieldPropertyDeclaration.FieldPropertyDeclarationDef;
